...
(1, 'aboutus', 'About Us', '<div><font color=\"#202124\" face=\"arial, sans-serif\"><b>Welcome to Swastha, where your health and well-being are our top priority. We are a multi-specialty clinic committed to providing comprehensive, high-quality healthcare services to individuals and families in our community. Our team of experienced and compassionate doctors is dedicated to delivering personalized care in a welcoming and comfortable environment.</b></font></div><div><font color=\"#202124\" face=\"arial, sans-serif\"><b><br></b></font></div><div><font color=\"#202124\" face=\"arial, sans-serif\"><b>At [Clinic Name], we believe in a patient-centered approach to healthcare. Our diverse team of specialists covers a wide range of medical fields, including:
...
Gastroenterology
And more...
Our state-of-the-art facility is equipped with the latest medical technology, allowing us to offer a variety of diagnostic and therapeutic services under one roof. From routine check-ups and preventive care to advanced treatments and specialized consultations, we are here to support you every step of the way on your health journey.

We take pride in fostering a collaborative and supportive environment where our doctors work together to ensure you receive the best possible care. Our commitment to continuing education and staying abreast of the latest medical advancements means you can trust that you are in capable hands.

Thank you for choosing Swastha. We look forward to being your trusted healthcare partner and helping you achieve and maintain optimal health.

</b></font></div>', NULL, NULL, NULL, ''),
(2, 'contactus', 'Contact Us', 'Mukherjeegate, Maheshtala, Kolkata-700141', 'swasthahealthclinic@gmail.com', 6290968452, NULL, '10:30 am to 7:30 pm');
